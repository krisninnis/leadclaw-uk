export default function DemoPage() {
  return (
    <div className="max-w-4xl mx-auto py-16 px-6 space-y-8">
      <h1 className="text-4xl font-bold">Try the AI Receptionist Live</h1>

      <p className="text-lg text-slate-600">
        Send a message below to see how LeadClaw captures enquiries and responds
        instantly to clinic visitors.
      </p>
